...
# Using your available Claude 3.5 Sonnet with direct model access (no cross-region inference restrictions)
BEDROCK_MODEL_ID = "anthropic.claude-3-5-sonnet-20240620-v1:0"  # Your exact available model
